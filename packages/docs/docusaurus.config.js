...
const config = {
  ...
  organizationName: 'quantmotion',
  projectName: 'quantmotion.github.io',
  i18n: {
    defaultLocale: 'en',
    locales: ['en'],
  },
  ...
  customFields: {
    ...
    githubApi: 'https://api.github.com/repos/quantmotion/quantmotion',
    githubUrl: 'https://github.com/quantmotion/quantmotion',
  },
  themeConfig:
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/quantmotion/quantmotion',
              },
            ],
          },
        ],
    ...
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        editUrl: ({versionDocsDirPath, docPath}) =>
          `https://github.com/quantmotion/quantmotion/blob/main/packages/docs/${versionDocsDirPath}/${docPath}`,
      },
    ],
    [
      '@docusaurus/plugin-content-blog',
      {
        ...
        editUrl: ({blogDirPath, blogPath}) =>
          `https://github.com/quantmotion/quantmotion/blob/main/packages/docs/${blogDirPath}/${blogPath}`,
      },
    ],
